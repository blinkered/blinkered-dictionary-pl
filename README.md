# Blinkered dictionary: Polish

The Polish word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Polish.

**330,328 of 544,157 candidates proved — 60.7%**, across 7 independent
families, 5 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Polish, and why those
...
Candidates come from Blinkered's Polish list, which lives in
[`blinkered-attestation/candidates/pl`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/pl).
...
file a subset of that dictionary and it carries that dictionary's terms — here `MPL-2.0`.
